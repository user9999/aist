...
<h3>Заказ №<?php echo $TEMPLATE['id'] ?> от <?php echo date('d.m.Y H:i', $TEMPLATE['date']) ?> <a href="?component=order&<?php echo $editorder ?>_id=<?php echo $TEMPLATE['id'] ?>">Удалить</a></h3><br />
<b>Заказчик:</b> <?php echo $user ?> &nbsp; <b>E-mail:</b> <?php echo $TEMPLATE['email'] ?><br />
<b>Сумма заказа:</b> <?php echo $TEMPLATE['price'] ?> руб. (<?php echo $TEMPLATE['sum'] ?> штук)<br />
<a href="?component=order&order_id=<?php echo $TEMPLATE['id'] ?>">Подробнее о заказе</a> <a href="javascript: void(0)" onclick="window.open('/csv.php?order_id=<?php echo $TEMPLATE['id'] ?>','csv','width=0,height=0,top=0,left=0,resize=0');return false" style="display:block;float:right;margin-right:7px"><img src="/img/csv.png" alt="" style="display:block;float:left"/> <span style="color:#000">CSV</span></a>
<a href="javascript: void(0)" onclick="window.open('/xls.php?order_id=<?php echo $TEMPLATE['id'] ?>','xls','width=0,height=0,top=0,left=0,resize=0');return false" style="display:block;float:right;margin-right:7px"><img src="/img/csv.png" alt="" style="display:block;float:left"/> <span style="color:#000">XLS</span></a>
</div>
<hr>
