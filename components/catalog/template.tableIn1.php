...
?>	
	...
	<td>
		...
		<?php 
		if ($TEMPLATE['action'] !="") {
			echo "<a class=\"underlined\" href='".$GLOBALS['PATH']."/catalog/".$linkage.$TEMPLATE['sid']."&amp;b=".urlencode($TEMPLATE['btitle'])."&amp;t=".urlencode($TEMPLATE['ftitle'])."'><img src='/img/zvezda.png' alt='' border=0 /></a>";
		} else{
      echo "&nbsp;";
     }
		?>			
