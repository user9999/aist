...
?>	
	...
	<td>
      ...
      echo " &nbsp; <a href='".$GLOBALS['PATH']."/catalog/".$linkage.$v['id']."&b=".$v['brandname']."&t=".$v['modelname']."'><img  alt=\"\" src=\"http://custom-truck.ru/templates/blank/img/cartadd.png\"></a>";
		} 
		?>			
	</td>		
<?php } ?>	
			...
			<?php if (!$nn) { ?><tr><td>Не найдено ни одной позиции.</td><?php } ?>
		</tr>
	</table>
</div>
