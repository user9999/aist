    ...
    function ($) {
        ...
        var contact = {
            ...
            init: function () {
                ...
                $('#contact-form input.contact, #contact-form a.contact').click(
                    function (e) {
                        e.preventDefault();

                        // load the contact form using ajax
                        $.get(
                            "/ajax/register.php", function (data) {
                ...
                $('#contact-form a.login').click(
                    function (e) {
                        e.preventDefault();

                        // load the contact form using ajax
                        $.get(
                            "/ajax/login.php", function (data) {
                                // create a modal dialog with the data
                                $(data).modal(
                                    {
                                        closeHTML: "<a href='#' title='Close' class='modal-close'>x</a>",
                                        ...
                                        $('#contact-container .contact-content').animate(
                                            {
                                                ...
                                                $('#contact-container form').fadeIn(
                                                    200, function () {
                                                        ...
                                                        $('#contact-container .contact-cc').click(
                                                            function () {
            ...
            validate: function () {
                ...
                if (!$('#contact-container #contact-secpic').val()) {
                    contact.message += 'Введите проверочный код. ';
                }
                //if (!$('#contact-container #contact-family').val()) {
                //contact.message += 'Введите Имя Фамилию. ';
                //}
