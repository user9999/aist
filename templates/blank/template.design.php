...
<link rel="stylesheet" href="<?php echo $PATH?>/css/oneclick.css?1">
...
<!--kvn_scripts-->
<!--kvn_script_user-->
<script type='text/javascript' src='<?php echo $PATH?>/js/jquery.simplemodal.js'></script>
<script src="<?php echo $PATH?>/js/contact.js"></script>
<?php
echo $GLOBALS['SCRIPT'];
?>
</head>
