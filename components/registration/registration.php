...
$arr = array('default'=>$GLOBALS['dblang_default'][$GLOBALS['userlanguage']],'view'=>$GLOBALS['dblang_view'][$GLOBALS['userlanguage']],'add'=>$GLOBALS['dblang_add'][$GLOBALS['userlanguage']],);
/*menu_array*/
...
renderActions($action, $arr, 'registration', false);
