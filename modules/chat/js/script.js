...
*/		
	...
	render : function(template,params){
		...
		switch(template){
			...
			case 'chatLine':
			//<span class="gravatar"><img src="',params.gravatar,'" width="23" height="23" onload="this.style.visibility=\'visible\'" />','</span>
				arr = [
					'<div class="chat chat-',params.id,' rounded"><span class="author">',params.nameAutor,
...
/*		
		...
		if(params.time) {
			...
			d.setUTCHours(params.time.hours,params.time.minutes,params.time.years,params.time.mounts,params.time.days);
		}
		
		params.time = d.getFullYear()+'.'+d.getMonth()+'.'+d.getDay()+' '+
...
$.tzPOST = function(action,data,callback){
	$.post('http://xn--80aacujpogtedm5od.xn--p1ai/modules/chat/php/ajax.php?action='+action,data,callback,'json');
}

$.tzGET = function(action,data,callback){
	$.get('http://xn--80aacujpogtedm5od.xn--p1ai/modules/chat/php/ajax.php?action='+action,data,callback,'json');
}
