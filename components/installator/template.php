...
<link rel="stylesheet" href="/templates/blank/style.css?2">
<link rel="stylesheet" href="<?=$PATH?>/css/contact.css">
<link rel="stylesheet" href="<?=$PATH?>/css/oneclick.css?1">
<link rel="stylesheet" href="<?=$PATH?>/inc/prettyPhoto.css" type="text/css" media="screen" title="prettyPhoto main stylesheet" charset="utf-8">
<?php
echo $GLOBALS['CSS'];
?>
<script type="text/javascript" src="<?=$PATH?>/inc/jquery_min.js"></script>
<script type="text/javascript" src="<?=$PATH?>/inc/jquery.cookie.js"></script>
<script type="text/javascript" src="<?=$PATH?>/inc/jquery.tablesorter.min.js"></script>
<script type="text/javascript" src="<?=$PATH?>/inc/dropDown.js"></script>
<script src="<?=$PATH?>/inc/jquery.prettyPhoto.js" type="text/javascript" charset="utf-8"></script>
<!--kvn_scripts-->
<!--kvn_script_user-->
...
?>
<a href="<?= $GLOBALS['PATH'] ?>/order"> <span id="cartno"><?= $amt ?></span> позиций на сумму <b><span id="cartsum"><?= $sum ?></span></b> <?= $GLOBALS['ZNAK'] ?></a></div>
</div>
<!-- -->
