...
<form method=post>
<table>
<tr><td><?php echo $GLOBALS['dblang_family'][$GLOBALS['userlanguage']] ?></td><td><input type=text name=family></td></tr>
<tr><td><?php echo $GLOBALS['dblang_phone'][$GLOBALS['userlanguage']] ?></td><td><input type=text name=phone></td></tr>
<tr><td><?php echo $GLOBALS['dblang_email'][$GLOBALS['userlanguage']] ?></td><td><input type=text name=email></td></tr>
