...
</td><td style="text-align:right">100 показов баннера - <?=$vars->ban_price;?>$ <a href="banner.php?act=ord" target="_blank">Заказать</a><br /><iframe src="rotate.php" id="bannerexchange" scrolling="no" frameborder="0" style="width:468px;height:60px;border:0px;padding:0;margin:0"></iframe></td></tr>
