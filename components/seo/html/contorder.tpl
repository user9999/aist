...
<tr><td>Стоимость клика не менее 3 центов<br />(может быть дробной напр. 3.5 - через точку!)</td><td><input type="text" size="4" name="price" onkeyup="clmoney()" onblur="check_price()" class="cash" value="" disabled="disabled" /> цента</td></tr>

<tr><td>Количество показов (минимум 100)</td><td><input type="text" size="4" name="amountshow" onkeyup="shmoney()" class="cash" value="" disabled="disabled" /> сумма <input type="text" class="cash" name="scash" size="4" value="0" disabled /> $ или <input type="text" name="srcash" class="cash" size="4" value="0" disabled  /> руб.</td></tr>
<tr><td>Количество переходов (минимум 10)</td><td><input type="text" size="4" name="amountclick" onkeyup="clmoney()" class="cash" value="" disabled="disabled" /> сумма <input type="text" class="cash" name="ccash" size="4" value="0" disabled /> $ или <input type="text" name="crcash" class="cash" size="4" value="0" disabled  /> руб.</td></tr>
