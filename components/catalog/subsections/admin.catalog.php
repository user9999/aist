...
$arr = array(1 => 'Управление разделами', 2 => 'Управление подразделами', 3 => 'Управление позициями', 4 => 'Обработка фото', 5 => 'Описания',6=>'Управление брендами',7=>'Загрузка текстов');
/*menu_array*/
